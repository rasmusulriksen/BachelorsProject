...
public interface INotificationService
{
    ...
    Task<MyNotificationsResponse> GetForUserAsync(string userId, int page, int pageSize);
    ...
    Task CreateAsync(NotificationFromJavaDto notificationDTO, CancellationToken cancellationToken);
    ...
    Task<long> GetUnreadCountForUserAsync(string userId);
    ...
    Task<long> GetTotalCountForUserAsync(string userId);
